                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex space-x-2">
                                ...
                                <a href="{{route('applicationShow',['id' => $application->app_id ])}}"
                                ...
                                <a href="{{ route('applicationEdit', ['id' => $application->app_id]) }}"
